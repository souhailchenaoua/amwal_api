...
class AmwalApi {
  ...
  factory AmwalApi({required AmwalApiBuilder builder}) {
    ...
    return builder
        .startPayment(builder._merchantId, builder._countryCode, builder._phoneNumber, builder._amount)
...
class AmwalApiBuilder {
  ...
  AmwalApiBuilder startPayment(String merchantId, String countryCode, String phoneNumber, double amount){
